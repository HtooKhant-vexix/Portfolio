...
const Skill = () => {
  return (
    <div className=" bg-primary/30 mt-[-165px] sm:mt-[-50px]  text-center">
      ...
      <div className="w-[90%] md:w-[65%] rounded-3xl  bg-opacity-30 mt-7 flex justify-center items-center bg-white border-white border mx-auto py-10 xs:h-[760px]">
        <div className="w-[90%] md:w-[90%] text-primary/90 rounded-3xl sm:gap-y-12 sm:px-4 py-6 px-5 sm:py-16 grid grid-cols-3 gap-3 sm:grid-cols-4 bg-opacity-30  bg-white border-white border sm:h-[660px]  xs:h-[860px]">
