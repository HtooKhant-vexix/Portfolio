    ...
    >
      <div className="w-full flex z-40 justify-center relative backdrop-blur-md bg-white bg-opacity-80 ">
        <div className="container relative flex items-center">
          ...
          {/* {chg && !show ? ( */}
          <div
            className={`w-[90%] mx-auto ${chg && !show ? "opacity-100 translate-y-[330px]" : "opacity-0" } mt-[-330px] z-30 inset-x-0 rounded-xl p-2 duration-500 bg-white/70 backdrop-blur-md fixed`}
          >
